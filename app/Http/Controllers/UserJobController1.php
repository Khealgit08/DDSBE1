...
//use App\User;
use App\Models\UserJob1; // <-- your model is located inside Models Folder
...
Class UserJobController1 extends Controller {
    ...
    */
    public function show($id) {
        $userjob = UserJob1::findOrFail($id);
